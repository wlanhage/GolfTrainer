...
type Props = NativeStackScreenProps<AppStackParamList, 'CaddyClubEditGrid'>;

export function CaddyClubEditGridScreen({ navigation }: Props) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Edit caddy</Text>
      <Text style={styles.subtitle}>Välj klubba för att lägga till eller ta bort slag.</Text>
